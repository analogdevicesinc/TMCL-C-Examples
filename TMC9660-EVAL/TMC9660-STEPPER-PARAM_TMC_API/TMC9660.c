...
// Helper functions
static int8_t tmc9660_boot_sendCommand_UART(uint16_t icID, uint8_t cmd, uint32_t *value);
static int32_t tmc9660_param_sendCommand_UART(uint16_t icID, uint8_t cmd, uint16_t type, uint8_t index, uint32_t *value);
...
int8_t tmc9660_boot_sendCommand(uint16_t icID, uint8_t cmd, uint32_t *value)
{
    ...
    {
        return tmc9660_boot_sendCommand_UART(icID, cmd, value);
    }
...
static int8_t tmc9660_boot_sendCommand_UART(uint16_t icID, uint8_t cmd, uint32_t *value)
{
    ...
    *value = ((uint32_t)data[3] << 24) | ((uint32_t)data[4] << 16) | ((uint32_t)data[5] << 8) | data[6];
...
int32_t tmc9660_param_sendCommand(uint16_t icID, uint8_t cmd, uint16_t type, uint8_t index, uint32_t *value)
{
    ...
    {
        return tmc9660_param_sendCommand_UART(icID, cmd, type, index, value);
    }
...
static int32_t tmc9660_param_sendCommand_UART(uint16_t icID, uint8_t cmd, uint16_t type, uint8_t index, uint32_t *value)
{
    ...
    *value = ((uint32_t)data[4] << 24) | ((uint32_t)data[5] << 16) | (data[6] << 8) | data[7];
...
uint32_t tmc9660_param_getParameter(uint16_t icID, uint16_t type)
{
    ...
    tmc9660_param_sendCommand(icID, TMC9660_CMD_GAP, type, 0, &value);
...
{
    int32_t result = tmc9660_param_sendCommand(icID, TMC9660_CMD_SAP, type, 0, &value);
