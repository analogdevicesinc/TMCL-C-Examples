...
Note: SPI support is limited to the TMC9660 running the SPI communication overhaul addon!
...
- These functions check the current active bus and calls the bus-specific function e.g. tmc9660_bl_sendCommand_UART, tmc9660_param_sendCommand_UART or tmc9660_reg_sendCommand_UART.
...
- For SPI, TMC-API also offers pipeline access function namely mc9660_param_sendPipelinedSPICommand.
