...
void setup()
{
    ...
    initAllMotors(IC_ID);
    tmc5130_writeRegister(IC_ID, TMC5130_VMAX, 125000);
    tmc5130_writeRegister(IC_ID, TMC5130_AMAX, 10000);

    Serial.println(tmc5130_readRegister(IC_ID, TMC5130_CHOPCONF), HEX);
}
