...
5V               | 05, 42      | +5V, +5V_VM
 ...
 2. Convert binary into the c array. Write command `xxd -i firmware.bin > firmware.h`. This generates a firmware.h file in the project folder. (The xxd command comes along with git.) 
