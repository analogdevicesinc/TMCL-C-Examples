...
void tmc6460_autogeneratedExample(uint16_t icID) {
    ...
    value = tmc6460_updateField(value, TMC6460_FOC_PID_TORQUE_FLUX_LIMITS_FLUX_FIELD, PID_FLUX_LIMIT); 
    value = tmc6460_updateField(value, TMC6460_FOC_PID_TORQUE_FLUX_LIMITS_TORQUE_FIELD, PID_TORQUE_LIMIT); 
...
void loop() {
    ...
    #ifdef USE_OPEN_LOOP
        tmc6460_openLoop(IC_ID);
    #else
        tmc6460_closedLoop(IC_ID);
    #endif
